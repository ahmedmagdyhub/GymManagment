...
{
    public  class GymManagmentDbContext : IdentityDbContext<ApplicationUser>
    {
        public GymManagmentDbContext(DbContextOptions<GymManagmentDbContext> option ): base (option )
        {
